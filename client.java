...
public class client extends javax.swing.JFrame {
 ...
 ResultSet rs;
    ...
    private void initComponents() {
        ...
        jLabel3.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 255, 255), new java.awt.Color(204, 204, 204)));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            rs=st.executeQuery("select macaddress from systemdetails");
          sys=cypher.decrypt(rs.getString("macaddress"));
            con.close();
            } 
                catch (Exception ex)
                {
        ...
        serverip=jTextField3.getText();
            if(enrollment.isEmpty()||serverip.isEmpty())
            {
                //do not proceed
            }
            else
